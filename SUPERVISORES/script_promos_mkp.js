...
function guardarImagen(event) {
  ...
  for (var i = 0; i < files.length; i++) {
    ...
    reader.onload = function (e) {
      ...
      // Cargar nuevamente todas las imágenes guardadas en localStorage
...
// Función para cargar y mostrar las imágenes guardadas en el almacenamiento local
function cargarImagenesGuardadas() {
  ...
  // Limpiar contenedor antes de cargar las imágenes
...
// Llamar a cargarImagenesGuardadas al cargar la página
